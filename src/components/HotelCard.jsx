...
const HotelCard = ({ room, index }) => {
  ...
  return (
    <Link to={`/hotelDetails/${room._id}`}
      onClick={() => scrollTo(0, 0)} className='relative w-[250px]  rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)] '>
      ...
      <div className='p-4 pt-5'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex gap-1 items-center'>
            <img src={Assets.starIcon} alt="starIcon" /> 4.5
          </div>
        </div>
